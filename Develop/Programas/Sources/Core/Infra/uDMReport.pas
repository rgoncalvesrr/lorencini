...
type
  TDMReport = class(TDataModule)
    ...
    R00013comodato_recno: TIntegerField;
    R00013tipo_port: TIntegerField;
    R00013rem_empresa: TStringField;
    R00013rem_cnpj: TStringField;
    R00013portador: TStringField;
    R00013rem_cpf: TStringField;
    R00013nf: TIntegerField;
    R00013nf_serie: TIntegerField;
    R00013nf_emissao: TDateField;
    R00013nf_valor: TFloatField;
    R00013status: TIntegerField;
    R00013ret_tipo: TIntegerField;
    R00013ret_empresa: TStringField;
    R00013ret_cnpj: TStringField;
    R00013ret_portador: TStringField;
    R00013ret_cpf: TStringField;
    R00013ret_nf: TIntegerField;
    R00013ret_serie: TIntegerField;
    R00013ret_emissao: TDateField;
    R00013ret_valor: TFloatField;
    R00014: TZQuery;
    ...
    R00017situacao: TIntegerField;
    R00017emi_dh: TDateTimeField;
    R00017emi_usr: TStringField;
    R00017emi_usrname: TStringField;
    R00017imp_dh: TDateTimeField;
    R00017imp_usr: TStringField;
    R00017imp_usrname: TStringField;
    R00017rem_dh: TDateTimeField;
    R00017rem_usr: TStringField;
    R00017rem_usrname: TStringField;
    R00017rem_tr: TMemoField;
    R00017ret_dh: TDateTimeField;
    R00017ret_usr: TStringField;
    R00017ret_usrname: TStringField;
    R00017ret_tr: TMemoField;
    R00017volume_1: TIntegerField;
    R00017tipo_1: TStringField;
    R00017envempresa: TStringField;
    R00017envcnpj: TStringField;
    R00017envnf: TIntegerField;
    R00017envnf_serie: TIntegerField;
    R00017envnf_emissao: TDateField;
    R00017envtipo_port: TIntegerField;
    R00017envtipo_outros: TStringField;
    R00017envportador: TStringField;
    R00017envcpf: TStringField;
    R00017envobs: TMemoField;
    R00017envemissao: TDateTimeField;
    ...
    R00017amostra_recno: TIntegerField;
