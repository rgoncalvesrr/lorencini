object DM: TDM
  ...
  object qClientes: TZQuery
    ...
    Left = 696
    Top = 64
    object qClientessituacao: TStringField
      DisplayLabel = ' '
      DisplayWidth = 15
      FieldName = 'situacao'
      Size = 100
    ...
    object qClientesempresa: TStringField
    ...
    object qClientestipo: TIntegerField
      Alignment = taLeftJustify
      DisplayLabel = 'Tipo de Cliente'
      FieldName = 'tipo'
      Required = True
      OnGetText = qClientestipoGetText
      OnSetText = qClientestipoSetText
    end
    ...
    object qClientesinscricao: TStringField
    ...
    object qClienteswebsite: TStringField
      DisplayLabel = 'Site'
      DisplayWidth = 40
      FieldName = 'website'
      Size = 100
    ...
    object qClientesid_vendedor: TIntegerField
      FieldName = 'id_vendedor'
      Visible = False
    end
    object qClientesvendedornome: TStringField
      DisplayLabel = 'Nome'
      DisplayWidth = 25
      FieldKind = fkLookup
    ...
    object qClientesfat_ende: TStringField
      DisplayLabel = 'Endere'#231'o'
      DisplayWidth = 25
      FieldName = 'fat_ende'
      Visible = False
    ...
    object qClientesfat_bair: TStringField
      DisplayLabel = 'Bairro'
      DisplayWidth = 20
      FieldName = 'fat_bair'
      Visible = False
    ...
    object qClientesfat_cep: TStringField
      DisplayLabel = 'CEP'
      DisplayWidth = 10
      FieldName = 'fat_cep'
      Visible = False
    ...
    object qClientesfat_cida: TStringField
      DisplayLabel = 'Cidade'
      DisplayWidth = 20
      FieldName = 'fat_cida'
      Visible = False
    ...
    object qClientesfat_esta: TStringField
      DisplayLabel = 'UF'
      DisplayWidth = 5
      FieldName = 'fat_esta'
      Visible = False
    ...
    object qClientesent_ende: TStringField
      DisplayLabel = 'Endere'#231'o'
      DisplayWidth = 25
      FieldName = 'ent_ende'
      Visible = False
    ...
    object qClientesent_bair: TStringField
      DisplayLabel = 'Bairro'
      DisplayWidth = 20
      FieldName = 'ent_bair'
      Visible = False
    ...
    object qClientesent_cep: TStringField
      DisplayLabel = 'CEP'
      DisplayWidth = 10
      FieldName = 'ent_cep'
      Visible = False
    ...
    object qClientesent_cida: TStringField
      DisplayLabel = 'Cidade'
      DisplayWidth = 20
      FieldName = 'ent_cida'
      Visible = False
    ...
    object qClientesent_esta: TStringField
      DisplayLabel = 'UF'
      DisplayWidth = 5
      FieldName = 'ent_esta'
      Visible = False
    ...
    object qClientescobra_ende: TStringField
      DisplayLabel = 'Endere'#231'o'
      DisplayWidth = 25
    ...
    object qClientescobra_bairro: TStringField
      DisplayLabel = 'Bairro'
      DisplayWidth = 20
    ...
    object qClientescobra_cep: TStringField
      DisplayLabel = 'CEP'
      DisplayWidth = 10
      FieldName = 'cobra_cep'
      Visible = False
    ...
    object qClientescobra_cida: TStringField
      DisplayLabel = 'Cidade'
      DisplayWidth = 20
    ...
    object qClientescobra_esta: TStringField
      DisplayLabel = 'UF'
      DisplayWidth = 5
    ...
    object qClientesobservacao: TMemoField
      DisplayLabel = 'Observa'#231#227'o'
      FieldName = 'observacao'
      Visible = False
      BlobType = ftMemo
    end
    object qClientesrestricao: TStringField
    ...
    object qClientesrestrmotiv: TMemoField
      DisplayLabel = 'Motivo'
    ...
    object qClientessenha: TStringField
      FieldName = 'senha'
      Visible = False
      Size = 16
    end
    object qClientestag_caption: TStringField
    ...
    object qClientescontato_tel: TStringField
      FieldName = 'contato_tel'
      Visible = False
      Size = 25
    end
    object qClientescontato_func: TStringField
      FieldName = 'contato_func'
      Visible = False
      Size = 54
    end
    object qClientescontato_cel: TStringField
      FieldName = 'contato_cel'
      Visible = False
      Size = 25
    end
    object qClientescontato_mail: TStringField
      FieldName = 'contato_mail'
      Visible = False
      Size = 100
    end
    object qClientescontato_nextel: TStringField
      DisplayLabel = 'Nextel ID'
      FieldName = 'contato_nextel'
      Size = 25
    end
    object qClientescontato_nextelcel: TStringField
    ...
    object qClienteslogo: TBlobField
      FieldName = 'logo'
      Visible = False
    end
  end
  object uClientes: TZUpdateSQL
    ...
    InsertSQL.Strings = (
      'INSERT INTO tbclientes'
        ...
        '  (empresa,         nome_chave,    endereco,      bairro,       ' +
        'cep,'
      
        '   cidade,          estado,        cnpj,          inscricao,    ' +
        'telefone,'
      
        '   fax,             website,       email,         id_vendedor,  ' +
        'situacao,'
      
        '   fat_ende,        fat_bair,      fat_cep,       fat_cida,     ' +
        'fat_esta,'
      
        '   ent_ende,        ent_bair,      ent_cep,       ent_cida,     ' +
        'ent_esta,'
      
        '   cobra_ende,      cobra_bairro,  cobra_cep,     cobra_cida,   ' +
        'cobra_esta,'
      
        '   observacao,      restricao,     restrmotiv,    dtcadastro,   ' +
        'senha,'
      
        '   tag_caption,     contato,       contato_func,  contato_tel,  ' +
        'contato_cel,'
      
        '   contato_mail,    cpf,           rg,            tipo,         ' +
        'recno,'
      '   contato_nextel,  logo,          contato_nextelcel)'
      'VALUES'
  ...
  object uContatos: TZUpdateSQL
    ...
    ModifySQL.Strings = (
      ...
      '  item = :OLD_item')
    UseSequenceFieldForRefreshSQL = False
    BeforeInsertSQL = uContatosBeforeInsertSQL
    Left = 288
    Top = 208
    ParamData = <
      item
  ...
  object qCallCenter: TZQuery
    Connection = Design
    SortedFields = 'data'
    UpdateObject = uCallCenter
    BeforePost = qCallCenterBeforePost
    SQL.Strings = (
    ...
    object qCallCenterid: TIntegerField
      FieldName = 'id'
      Visible = False
    end
    object qCallCentercodigo: TIntegerField
      DisplayLabel = 'Cliente'
      FieldName = 'codigo'
      Required = True
      Visible = False
    end
    object qCallCenterempresa: TStringField
    ...
    object qCallCenternome_chave: TStringField
    ...
    object qCallCenterdata: TDateTimeField
      DisplayLabel = 'Data'
      FieldName = 'data'
      DisplayFormat = 'dd/mm/yyy hh:nn:ss'
    end
    object qCallCenterusername: TStringField
      DisplayLabel = 'Usu'#225'rio'
      FieldName = 'username'
      Visible = False
    end
    object qCallCentername: TStringField
      DisplayLabel = 'Atendente'
      FieldName = 'name'
      ReadOnly = True
      Size = 40
    end
    object qCallCentercontato: TIntegerField
      DisplayLabel = 'Contato'
      FieldName = 'contato'
      Visible = False
    end
    object qCallCenternome: TStringField
      DisplayLabel = 'Contato'
      DisplayWidth = 25
      FieldName = 'nome'
      Size = 60
    end
    object qCallCenterfuncao: TStringField
      DisplayLabel = 'Fun'#231#227'o'
      DisplayWidth = 20
      FieldName = 'funcao'
      Size = 54
    end
    object qCallCentertelefone: TStringField
      DisplayLabel = 'Telefone'
      DisplayWidth = 15
      FieldName = 'telefone'
      Size = 100
    end
    object qCallCentercelular: TStringField
      DisplayLabel = 'Celular'
      DisplayWidth = 15
      FieldName = 'celular'
      Size = 100
    end
    object qCallCenteremail: TStringField
      DisplayLabel = 'Email'
      DisplayWidth = 25
      FieldName = 'email'
      Size = 100
    end
    object qCallCenterdescri: TMemoField
      DisplayLabel = 'Descri'#231#227'o'
      FieldName = 'descri'
      Required = True
      Visible = False
    ...
    object qCallCenteros: TIntegerField
      DisplayLabel = 'OS'
      FieldName = 'os'
      Visible = False
    end
  end
  object dsCallCenter: TDataSource
    AutoEdit = False
    DataSet = qCallCenter
    Left = 504
    Top = 400
  end
  object uCallCenter: TZUpdateSQL
    DeleteSQL.Strings = (
    ...
    InsertSQL.Strings = (
      ...
      '  (codigo, username, contato, descri, os)'
      'VALUES'
      '  (:codigo, :username, :contato, :descri, :os)')
    ModifySQL.Strings = (
      'UPDATE callcenter SET'
      '  codigo = :codigo,'
      '  data = :data,'
      '  username = :username,'
      '  contato = :contato,'
