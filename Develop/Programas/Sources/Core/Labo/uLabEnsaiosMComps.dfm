inherited LabEnsaiosMComps: TLabEnsaiosMComps
  Caption = 'Manuten'#231#227'o de Ensaios Compostos'
  ClientHeight = 250
  ExplicitWidth = 645
  ExplicitHeight = 278
  PixelsPerInch = 96
        ...
        object Panel6: TPanel
          ...
          object Panel7: TPanel
            ...
            object DBEdit4: TDBEdit
              ...
              Margins.Right = 0
              Align = alClient
              DataField = 'ensaio_comp'
              DataSource = LabEnsaios.dsLabEnsComp
              TabOrder = 0
              OnExit = DBEdit4Exit
            end
          end
  ...
  inherited alDef: TActionList
    object actFindEnsaio: TAction
      ImageIndex = 332
      OnExecute = actFindEnsaioExecute
    end
  end
end
