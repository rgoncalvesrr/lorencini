inherited LabTiposLaudosMDiag: TLabTiposLaudosMDiag
  Caption = 'Manuten'#231#227'o de Diagn'#243'stico por Laudo'
  ClientHeight = 320
  ExplicitHeight = 349
  PixelsPerInch = 96
  TextHeight = 15
  inherited Panel1: TPanel
    ...
    inherited PageControl1: TPageControl
      ...
      inherited TabSheet1: TTabSheet
        Caption = 'Diagn'#243'stico po Laudo'
        ExplicitHeight = 240
        ...
        object DBEdit1: TDBEdit
          ...
          DataSource = LabTiposLaudos.dsDiag
          TabOrder = 3
          OnExit = DBEdit1Exit
        end
  ...
  inherited alDef: TActionList
    Left = 200
    object actFindDiag: TAction
      ImageIndex = 332
      OnExecute = actFindDiagExecute
    end
  end
end
