...
type
  TLabTipoMClasse = class(TIDefBrowseEdit)
    Label1: TLabel;
    DBEdit1: TDBEdit;
    Label2: TLabel;
    DBEdit2: TDBEdit;
...
var
  LabTipoMClasse: TLabTipoMClasse;

implementation

uses uLabTipo, uIUtils, mcUtils, DB, uLabTensao, uLabTipoM;

{$R *.dfm}

procedure TLabTipoMClasse.actFindClasseExecute(Sender: TObject);
begin
  inherited;
  try
...
procedure TLabTipoMClasse.DBEdit7Exit(Sender: TObject);
var
  fLkp: TStringList;
begin
...
procedure TLabTipoMClasse.RefreshControls;
begin
  inherited;
