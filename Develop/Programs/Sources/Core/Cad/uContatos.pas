...
type
  TContatos = class(TIDefBrowse)
    ...
    qContClienviar_pedido_venda: TBooleanField;
    qContClienviar_cotacao_venda: TBooleanField;
...
begin
  ...
  qContClienviar_cotacao_venda.AsBoolean := not IBrwSrcemail.IsNull;
  qContClienviar_pedido_venda.AsBoolean := not IBrwSrcemail.IsNull;
